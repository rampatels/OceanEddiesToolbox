function newTracks = EddiesBornInROI(lonlimit, latlimit, tracks)
% This function identifies eddies that are born in the region of interest
...
nfile = length(tracks);
parfor fInd = 1:nfile
    lon = tracks{fInd}(1,2); % born in this region
    lat = tracks{fInd}(1,1); % born in this region
